...
$sorgu="insert into genislikyol_900913(anaobjeid,kmbaslangic,kmbitis, yapimyili,genislik,geom) values ('$gelenYolId','$gelenBaslangicKm','$gelenBitisKm','$gelenyapimyili',' $gelengenislik',(select ST_Line_substring(geom,$basla,$bitir) from (select * from bilecikyollardb)  as foo where objectid='$gelenYolId'))";
 echo $sorgu;
